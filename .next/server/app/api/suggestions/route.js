"use strict";(()=>{var e={};e.id=152,e.ids=[152],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7718:e=>{e.exports=require("node:child_process")},6005:e=>{e.exports=require("node:crypto")},7561:e=>{e.exports=require("node:fs")},3977:e=>{e.exports=require("node:fs/promises")},9411:e=>{e.exports=require("node:path")},1747:e=>{e.exports=require("node:readline")},4492:e=>{e.exports=require("node:stream")},6402:e=>{e.exports=require("node:stream/promises")},7261:e=>{e.exports=require("node:util")},5185:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>h,patchFetch:()=>m,requestAsyncStorage:()=>c,routeModule:()=>p,serverHooks:()=>g,staticGenerationAsyncStorage:()=>d});var i={};s.r(i),s.d(i,{POST:()=>l});var r=s(9303),n=s(8716),o=s(670),a=s(7070);let u=new(s(3037)).ZP;async function l(e){var t,s;let i,r,n,o;try{let t=await e.json();if(i=t.jdText,r=t.resume,n=t.verdict,o=t.verdictReasoning,!i||!r||!n||null==o)throw Error("missing fields")}catch{return a.NextResponse.json({error:"invalid_request",message:"Missing required fields in request body."},{status:400})}let l=r.sections.map(e=>{if("data"in e){let t=e.data;return["SECTION: Header",`Name: ${t.name}`,t.title?`Current Title: ${t.title}`:null,t.location?`Location: ${t.location}`:null,t.email?`Email: ${t.email}`:null].filter(Boolean).join("\n")}return`SECTION: ${e.title}
${e.content}`}).join("\n\n---\n\n"),p=r.sections.map(e=>"data"in e?"Header":e.title).join(", "),c=(t=n,s=o,"apply"===t?`The verdict is "apply" — this is already a strong match.
...
Verdict reasoning (for context): ${s}`:"apply_conditionally"===t?`The verdict is "apply_conditionally" — there is meaningful overlap but real gaps to address.
...
Verdict reasoning (for context): ${s}`:`The verdict is "skip" — this is a weak match.
...
Verdict reasoning (for context): ${s}`),d=`You are reviewing a candidate's resume against a specific job description to generate targeted edit suggestions.
